...
client.on("messageReactionAdd", (reaction, user) => {
  ...
  if (reaction.message.id === '747650208514572378') {
    switch (name) {
      case '🍎':
        member.roles.add('123')
        break;
      case '🍌':
        member.roles.add('1234')
        break;
      case '🍇':
        member.roles.add('12345')
        break;
      case '🍑':
        member.roles.add('123456')
        break;
    }
  }
});
...
client.on("messageReactionRemove", (reaction, user) => {
  ...
  if (reaction.message.id === '747650208514572378') {
    switch (name) {
      case '🍎':
        member.roles.remove('123')
        break;
      case '🍌':
        member.roles.remove('1234')
        break;
      case '🍇':
        member.roles.remove('12345')
        break;
      case '🍑':
        member.roles.remove('123456')
        break;
    }
  }
});
